...
const CareerJourneySection = () => {
  ...
  return (
    <section id="career" className="py-32" ref={ref}>
          ...
          <div className="space-y-12">
            {jobs.map((job, i) => (
              ...
              >
                ...
                {/* Card */}
                <div className="glass-panel p-6 md:p-8 flex-1 group hover:scale-[1.01] transition-transform duration-300">
